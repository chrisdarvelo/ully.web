...
const SOCIALS = [
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@ullycoffee',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/ullycoffee',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/company/ullycoffee',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/chrisdarvelo',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
const ICON_STYLE: React.CSSProperties = {
  ...
  width: 38, height: 38, borderRadius: 4, border: '1px solid #1E1A17',
  color: '#6B5E52', transition: 'color 0.15s, border-color 0.15s, background 0.15s',
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            <input
              ...
              required
              style={{
                background: '#1A1614', border: '1px solid #1E1A17', borderRadius: 3,
                padding: '10px 16px', color: '#C4B8AA', fontSize: 13,
