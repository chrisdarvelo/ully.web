...
const MODULES = [
  ...
  },
  {
    ...
    desc: 'Know your numbers before your bank statement does. Log revenue, track expenses, and get instant answers on what\'s driving your business.',
    points: [
  ...
  },
  {
    ...
    desc: 'A complete register of every machine in your operation with full service history — so nothing slips through the cracks.',
    points: [
  ...
  },
  {
    ...
    desc: 'Your full team roster with roles, scheduling, and skill tracking — all in one place. From hire to shift, covered.',
    points: [
      'Add team members with role, hourly rate, and contact info',
      'Weekly shift planner with visual calendar across all staff',
